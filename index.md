...
## <a id="latest" name="latest_event"></a>【次回開催案内】第40回サービスコンピューティング研究会

- __テーマ:__  「社会変化に伴う際のサービスとソフトウェア・システム構築とその高度化」および一般
- __日程：__ 2021年11月5日（金）- 6日（土）
- __会場：__ オンライン＋現地（SC：神戸大学，KBSE：盛岡市）（ハイブリッド開催，主：オンライン開催，副：現地開催）
- __共催__： [電子情報通信学会KBSE研究会](https://www.ieice.org/iss/kbse/)

### 開催案内

次回第40回のSC研究会は，11/5-6にKBSE研究会と合同開催を行います．
今年度は，オンラインに加えて，サービスコンピューティング研究会／知能ソフトウェア工学研究会で会場をそれぞれ準備し，現地参加でない方は双方の会場へオンラインで参加するハイブリッド形式で開催予定です．

今回のテーマは「社会変化に伴う際のサービスとソフトウェア・システム構築」です．コロナ禍がもたらした社会変化に対し，どのようなサービスやソフトウェアを構築していくべきかを考えるテーマになっており，以下の目玉企画を準備中です．
- コロナ禍における __新たなリモート活動のためのハッカソン__
- __EventIn (仮)を活用したポスターセッション__ (申し込みの際に論文あり・なしを選択できます)
...
#### 参加申込要領 
- __発表申込締切 ：__ 2021年9月13日（月）
- __原稿締切：__ 開催日の約3週間前となります．正確な日付は，お申し込み後，学会事務局より送付される案内メールをご参照ください．
- __論文ページ数 ：__ 8ページ以内 
- __発表時間 :__ 以下より選択できます (※申込件数によって，発表時間が短くなる場合があります)
...
参加者の属性に応じて[聴講参加費の支払い](https://www.ieice.org/ken/user/index.php?cmd=participation&tgs_regid=4307fdfa5ae66dfad7d72e605b072ee07929712e1dc15544b77af62eb6e1993f)が必要となります．
- __照会先：__
	- （SC研究会について）木村 功作（富士通）kimura.kosaku@fujitsu.com
	- （KBSE研究会について）猿渡 卓也 (NTTデータ) 
